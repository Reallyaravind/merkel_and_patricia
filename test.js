 ...
 * The below section is used to test Merkel Treee
 */
...
transactionList.list[2].to = "Aravind";
// console.log(util.inspect(transactionList, false, null, true /* enable colors */));
tree.verify(transactionList.list[2]);

/**
 * Uncomment this section for testing Patria Trie
 * Uncomment the console log with util to get detailed logs
 * The below section is used to test patricia Trie
 */
